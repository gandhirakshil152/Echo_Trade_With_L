...
import { a as setupBrokerAccount, c as createSsrRpc, d as ThemeToggle, f as useServerFn, i as setBrokerConnection, l as Badge, n as getWorkspace, o as toggleWatchlist, r as placeOrder, s as verifyBrokerPin, u as TopBar } from "./trading.functions-BgC54RMs.js";
...
import { a as cn, i as Button, n as useAuth, r as Input, t as enableDemoMode } from "./useAuth-BIIuovti.js";
import { a as Label, i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-CHVjNmMZ.js";
...
import { Area, AreaChart, Bar, BarChart, CartesianGrid, Cell, ComposedChart, Customized, Line, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
...
var CandleTooltip = ({ active, payload }) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			d.sma20 != null && /* @__PURE__ */ jsxs("div", {
			...
			d.sma50 != null && /* @__PURE__ */ jsxs("div", {
			...
			d.volume != null && /* @__PURE__ */ jsxs("div", {
...
var LineTooltip = ({ active, payload }) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [d?.label && /* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h3", {
				...
				children: [symbol, /* @__PURE__ */ jsxs("span", {
				...
				children: [data?.live ? "🟢 Live market feed" : "📡 Indicative feed", last > 0 && /* @__PURE__ */ jsx("span", {
		...
		}), isLoading && !rows.length ? /* @__PURE__ */ jsx(Skeleton, { className: "h-72 w-full rounded-xl" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
			/* @__PURE__ */ jsx("div", {
					...
					children: chartType === "candle" ? /* @__PURE__ */ jsxs(ComposedChart, {
						...
						children: [
							...
							/* @__PURE__ */ jsx(Tooltip, {
								content: /* @__PURE__ */ jsx(CandleTooltip, {}),
								cursor: {
									stroke: "var(--border)",
									strokeWidth: 1,
									strokeDasharray: "4 2"
							...
							/* @__PURE__ */ jsx(Customized, { component: CandlestickBars })
						]
						...
						children: [
							...
							/* @__PURE__ */ jsx(Tooltip, {
								content: /* @__PURE__ */ jsx(LineTooltip, {}),
								cursor: {
									stroke: "var(--border)",
									strokeWidth: 1,
									strokeDasharray: "4 2"
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: "inline-block h-0.5 w-4 rounded-full bg-blue-400" }), " SMA 20"]
					}),
					/* @__PURE__ */ jsxs("span", {
						className: "flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx("span", { className: "inline-block h-0.5 w-4 rounded-full bg-orange-400" }), " SMA 50"]
					}),
					...
					showVWAP && /* @__PURE__ */ jsxs("span", {
						className: "flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx("span", { className: "inline-block h-0.5 w-4 rounded-full bg-amber-400" }), " VWAP"]
					}),
					/* @__PURE__ */ jsxs("span", {
						className: "ml-auto flex items-center gap-2 font-mono",
						children: [/* @__PURE__ */ jsxs("span", {
							className: "flex items-center gap-1",
							children: [/* @__PURE__ */ jsx("span", { className: "inline-block w-3 h-3 border border-emerald-400 rounded-sm" }), " Bull (hollow)"]
						}), /* @__PURE__ */ jsxs("span", {
							className: "flex items-center gap-1",
							children: [/* @__PURE__ */ jsx("span", { className: "inline-block w-3 h-3 bg-red-500 rounded-sm opacity-90" }), " Bear (filled)"]
						})]
					})
				]
			}),
