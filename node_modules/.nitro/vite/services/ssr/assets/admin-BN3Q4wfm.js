import { f as useServerFn, l as Badge, t as getAdminOverview, u as TopBar } from "./trading.functions-BFr6kfAt.js";
import { a as brokerLabel, s as formatINR } from "./stocks-BlNLqOub.js";
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("h1", {
							...
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "size-6 text-primary" }), " Admin control room"]
						}),
						/* @__PURE__ */ jsx(Badge, {
							variant: "outline",
							children: "restricted"
				...
				data ? /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsx("div", {
						...
						].map((k) => /* @__PURE__ */ jsxs("section", {
							className: "panel p-5",
							children: [
								/* @__PURE__ */ jsx(k.icon, { className: "size-5 text-primary" }),
								/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: users.map((u) => /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: u.brokers.map((b) => /* @__PURE__ */ jsxs("span", {
									...
									u.holdings.length ? /* @__PURE__ */ jsx("div", {
										className: "flex flex-wrap gap-2",
										children: u.holdings.map((h) => /* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							className: "divide-y divide-border/50",
							children: orders.slice(0, 60).map((o) => /* @__PURE__ */ jsxs("div", {
