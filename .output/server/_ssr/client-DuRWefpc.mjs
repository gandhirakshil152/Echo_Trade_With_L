...
//#region node_modules/.nitro/vite/services/ssr/assets/client-DuRWefpc.js
...
var previewAuthStorage_exports = /* @__PURE__ */ __exportAll({ brokeredPreviewStorage: () => brokeredPreviewStorage });
...
function createSupabaseClient() {
	const SUPABASE_URL = (typeof import.meta !== "undefined" ? {
		...
		"VITE_GEMINI_API_KEY": "AQ.Ab8RN6Kp6zsySfZwr73exq41ikEds-cuEH5CbDg8T0xWiBZx2w",
		"VITE_SUPABASE_PROJECT_ID": "kmovmozyjwvkstzxvmsz",
		"VITE_SUPABASE_PUBLISHABLE_KEY": "sb_publishable_r61arn8pJceTS77IxIGI7A_PfEhPd3c",
		"VITE_SUPABASE_URL": "https://c--81355976-f42e-4a47-a5c3-aef97d0f6bd0-prod.lovable.cloud"
	}["VITE_SUPABASE_URL"] : void 0) || (typeof processModule !== "undefined" ? processModule.env["SUPABASE_URL"] : void 0);
	const SUPABASE_PUBLISHABLE_KEY = (typeof import.meta !== "undefined" ? {
		...
		"VITE_SUPABASE_PUBLISHABLE_KEY": "sb_publishable_r61arn8pJceTS77IxIGI7A_PfEhPd3c",
		"VITE_SUPABASE_URL": "https://c--81355976-f42e-4a47-a5c3-aef97d0f6bd0-prod.lovable.cloud"
	}["VITE_SUPABASE_PUBLISHABLE_KEY"] : void 0) || (typeof processModule !== "undefined" ? processModule.env["SUPABASE_PUBLISHABLE_KEY"] : void 0);
	...
	if (isInLovablePreview()) try {
		const { brokeredPreviewStorage } = __toCommonJS(previewAuthStorage_exports);
		storageAdapter = {
