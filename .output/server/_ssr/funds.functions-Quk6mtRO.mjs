...
//#region node_modules/.nitro/vite/services/ssr/assets/funds.functions-Quk6mtRO.js
...
var savePinnedIndices = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({ indices: arrayType(stringType().max(20)).max(8) }).parse(input)).handler(savePinnedIndices_createServerFn_handler, async ({ data, context }) => {
